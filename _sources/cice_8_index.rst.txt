...
.. csv-table:: Alphabetical Index
   ...
   "kice", "thermal conductivity of fresh ice (:cite:`BL99`)", "2.03 W/m/deg"
   ...
   "ktherm", ":math:`\bullet` thermodynamic formulation (0 = zero-layer, 1 = :cite:`BL99`, 2 = mushy)", ""        
   "**L**", "", ""
   ...
   "nit_data_type", ":math:`\bullet` forcing type for nitrate", ""
   ...
   "restore_sst", ":math:`\bullet` restore sst to data", ""
   ...
   "saltmax", "max salinity, at ice base (:cite:`BL99`)", "3.2 ppt"
   ...
   "sil_data_type", ":math:`\bullet` forcing type for silicate", ""
   ...
   "sss_data_type", ":math:`\bullet` source of surface salinity data", ""
   "sst", "sea surface temperature", "C"
   "sst_data_type", ":math:`\bullet` source of surface temperature data", ""
