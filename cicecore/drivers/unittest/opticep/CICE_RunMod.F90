...
!tcxzsal            if (solve_zsal) call zsal_diags
...
!tcxzsal            if (solve_zsal .or. skl_bgc .or. z_tracers) &
...
!tcxzsal            fzsal_ai  (i,j,iblk) = fzsal  (i,j,iblk)
...
!tcxzsal                            fzsal    (:,:,iblk), fzsal_g (:,:,iblk), &
