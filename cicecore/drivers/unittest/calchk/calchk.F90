      ...
      character(len=8) :: errorflag1A,errorflag2A,errorflag3A
    ...
    do n = 1,3
      ...
      !-----------------
      ! This test makes sure calendar_compute_elapsed_days works for different calendars
      ! and multiple years.  This also check that the timesecs value computed in calendar
      ! and passed into calendar_set_date_from_timesecs returns the correct date.
      !-----------------
      ...
      do nyr = 0,nyrmax
         do month = 1,months_per_year
            do mday = 1,daymo(month)
               ...
               errorflag2 = passflag
               call calendar()
               nday = calendar_compute_elapsed_days(nyr,month,mday)
      ...
      write(6,*) ' '
      write(6,*) trim(errorflag1A)," ... ",trim(str1)," calendar_compute_elapsed_days: ",nyrmax," years "
      write(6,*) trim(errorflag2A)," ... ",trim(str1)," calendar_set_date_from_timesecs: ",nyrmax," years "
