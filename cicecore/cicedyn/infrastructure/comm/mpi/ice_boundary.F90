...
!  Generated by ./generate_haloUpdates.sh on 2026-04-21
      ...
      do iblk = 1, halo%numLocalBlocks
         ...
         if (iblock == 1) then                      ! west edge
            ...
            elseif (halo%ewBoundaryType == 'linear_extrap'  ) then
               ...
               do i = 1,nghost
                  array(i,j,iblk) = array(ilo,j,iblk) - &
                     real((nghost-i+1),real_kind)*(array(ilo+1,j,iblk)-array(ilo,j,iblk))
               enddo
               enddo
            endif
         endif
         ...
         if (iblock == nblocks_x) then              ! east edge
            ...
            elseif (halo%ewBoundaryType == 'linear_extrap') then
               ...
               do i = 1,nghost
                  array(ihi+i,j,iblk) = array(ihi,j,iblk) + &
                     real((i),real_kind)*(array(ihi,j,iblk)-array(ihi-1,j,iblk))
               enddo
               enddo
            endif
         endif
         ...
         if (jblock == 1) then                      ! south edge
            ...
            elseif (halo%nsBoundaryType == 'linear_extrap'  ) then
               ...
               do i = ilo-nghost,ihi+nghost
                  array(i,j,iblk) = array(i,jlo,iblk) - &
                     real((nghost-j+1),real_kind)*(array(i,jlo+1,iblk)-array(i,jlo,iblk))
               enddo
               enddo
            endif
         endif
         ...
         if (jblock == nblocks_y) then              ! north edge
            ...
            elseif (halo%nsBoundaryType == 'linear_extrap') then
               ...
               do i = ilo-nghost,ihi+nghost
                  array(i,jhi+j,iblk) = array(i,jhi,iblk) + &
                     real((j),real_kind)*(array(i,jhi,iblk)-array(i,jhi-1,iblk))
               enddo
               enddo
            endif
         endif
      ...
      do iblk = 1, halo%numLocalBlocks
         ...
         if (iblock == 1) then                      ! west edge
            ...
            elseif (halo%ewBoundaryType == 'linear_extrap'  ) then
               ...
               do i = 1,nghost
                  array(i,j,iblk) = array(ilo,j,iblk) - &
                     int((nghost-i+1),int_kind)*(array(ilo+1,j,iblk)-array(ilo,j,iblk))
               enddo
               enddo
            endif
         endif
         ...
         if (iblock == nblocks_x) then              ! east edge
            ...
            elseif (halo%ewBoundaryType == 'linear_extrap') then
               ...
               do i = 1,nghost
                  array(ihi+i,j,iblk) = array(ihi,j,iblk) + &
                     int((i),int_kind)*(array(ihi,j,iblk)-array(ihi-1,j,iblk))
               enddo
               enddo
            endif
         endif
         ...
         if (jblock == 1) then                      ! south edge
            ...
            elseif (halo%nsBoundaryType == 'linear_extrap'  ) then
               ...
               do i = ilo-nghost,ihi+nghost
                  array(i,j,iblk) = array(i,jlo,iblk) - &
                     int((nghost-j+1),int_kind)*(array(i,jlo+1,iblk)-array(i,jlo,iblk))
               enddo
               enddo
            endif
         endif
         ...
         if (jblock == nblocks_y) then              ! north edge
            ...
            elseif (halo%nsBoundaryType == 'linear_extrap') then
               ...
               do i = ilo-nghost,ihi+nghost
                  array(i,jhi+j,iblk) = array(i,jhi,iblk) + &
                     int((j),int_kind)*(array(i,jhi,iblk)-array(i,jhi-1,iblk))
               enddo
               enddo
            endif
         endif
