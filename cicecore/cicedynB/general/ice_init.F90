...
! author Elizabeth C. Hunke, LANL
      ...
      use ice_grid, only: grid_file, gridcpl_file, kmt_file, &
                          ...
                          grid_lonref, grid_latref, pgl_global_ext
      ...
      namelist /grid_nml/ &
        ...
        dxscale,        dyscale,         grid_lonref,   grid_latref,    &
        scale_dxdy,                                                     &
...
!         file=__FILE__, line=__LINE__)
      ...
      grid_lonref = -156.50_dbl_kind  ! lower left corner lon for rectgrid
      grid_latref =   71.35_dbl_kind  ! lower left corner lat for rectgrid
      ...
      call broadcast_scalar(grid_lonref,          master_task)
      call broadcast_scalar(grid_latref,          master_task)
