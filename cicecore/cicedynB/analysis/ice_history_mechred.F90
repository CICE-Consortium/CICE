...
#ifdef DMI_nml
      use ice_fileunits, only: nu_nml, nml_filename_mechred, &
#else
...
#ifdef DMI_nml
         open (nu_nml, file=nml_filename_mechred, status='old',iostat=nml_error)
#else
...
#ifdef DMI_nml
         print*,'Reading icefields_mechred_nml'
#endif
