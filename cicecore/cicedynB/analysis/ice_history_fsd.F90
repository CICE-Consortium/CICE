...
! authors Elizabeth C. Hunke, LANL
      ...
      if (f_wave_sig_ht(ns:ns) == histfreq(ns)) &
...
!=======================================================================
      ...
      do ns = 1, nstreams
         ...
         if (f_dafsd_newi(ns:ns) == histfreq(ns)) &
         ...
         if (f_dafsd_latg(ns:ns) == histfreq(ns)) &
         ...
         if (f_dafsd_latm(ns:ns) == histfreq(ns)) &
...
! author:   Elizabeth C. Hunke, LANL
      ...
      if (f_aice_ww(ns:ns)== histfreq(ns)) then
         do j = 1, ny_block
         do i = 1, nx_block
            worka(i,j) = c0
            do n = 1, ncat_hist
      ...
      if (f_diam_ww (ns:ns) == histfreq(ns)) then
         do j = 1, ny_block
         do i = 1, nx_block
            worka(i,j) = c0
            workb      = c0
      ...
      if (f_hice_ww (ns:ns) == histfreq(ns)) then
         do j = 1, ny_block
         do i = 1, nx_block
            worka(i,j) = c0
            workb      = c0
      ...
      if (f_fsdrad(ns:ns) == histfreq(ns)) then
         do j = 1, ny_block
         do i = 1, nx_block
            worka(i,j) = c0            
      ...
      if (f_fsdperim(ns:ns) == histfreq(ns)) then
         do j = 1, ny_block
         do i = 1, nx_block
            worka(i,j) = c0
            if (aice_init(i,j,iblk) > puny) then
      ...
      if (f_afsd(ns:ns) == histfreq(ns)) then
         do j = 1, ny_block
         do i = 1, nx_block
            do k = 1, nfsd_hist
               worke(i,j,k)=c0
      ...
      if (f_afsdn(ns:ns) == histfreq(ns)) then
         do n = 1, ncat_hist
         do k = 1, nfsd_hist 
         do j = 1, ny_block
         do i = 1, nx_block
