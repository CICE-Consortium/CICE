...
!=======================================================================
      ...
      allocate(                                       &
         ...
         fswthrunvdr  (nx_block,ny_block,ncat,max_blocks), & ! vis dir SW through ice to ocean            (W/m^2)
         fswthrunvdf  (nx_block,ny_block,ncat,max_blocks), & ! vis dif SW through ice to ocean            (W/m^2)
         fswthrunidr  (nx_block,ny_block,ncat,max_blocks), & ! nir dir SW through ice to ocean            (W/m^2)
         fswthrunidf  (nx_block,ny_block,ncat,max_blocks), & ! nir dif SW through ice to ocean            (W/m^2)
