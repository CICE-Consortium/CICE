...
project = u'CICE'
copyright = u'2025, Triad National Security, LLC (code) and National Center for Atmospheric Research (documentation)'
...
# To manually specify the version, uncomment the following line and enter information.
...
latex_documents = [
    (master_doc, 'CICE.tex', u'CICE Documentation',
...
man_pages = [
    (master_doc, 'CICE', u'CICE Documentation',
     [author], 1)
]
