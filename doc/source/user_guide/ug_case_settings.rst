...
.. csv-table:: *Namelist options*
   ...
   "","``restart_aero``", "true/false", "restart tracer values from file", ""
     "\*","``tr_aero``", "true/false", "floe size distribution", ""
   "","``restart_aero``", "true/false", "restart floe size distribution values from file", ""
   "","", "", "", ""
   "","*thermo_nml*", "", "", ""
   "","", "", "**Thermodynamics**", ""
   ...
   "","``wave_spec``", "true/false", "use ocean surface wave spectral forcing", ""
