...
.. csv-table:: Table 8
   ...
   "", "``-1``", "one category", ""
   "``dxrect``", "x-direction grid spacing (meters) for rectangular grid", ""
   "``dyrect``", "y-direction grid spacing (meters) for rectangular grid", ""
   "", "", "", ""
   "*domain_nml*", "", "", ""
   "", "", "*Domain*", ""
   ...
   "``coriolis``", "default", "how coriolis is defined", "default"
   "", "``constant``", "Constant coriolis", "1.46e-4"
   "", "``zero``", "Zero coriolis", "0.0"
   "", "", "", ""
   "*shortwave_nml*", "", "", ""
   "", "", "*Shortwave*", ""
