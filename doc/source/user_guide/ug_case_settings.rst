...
.. csv-table:: **dynamics_nml namelist options**
   ...
   "``im_fgmres``", "integer", "maximum number of Arnoldi iterations for FGMRES solver", "50"
   "``im_pgmres``", "integer", "maximum number of Arnoldi iterations for PGMRES preconditioner", "5"
