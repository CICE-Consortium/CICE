...
.. csv-table:: *Namelist options*
   ...
   "","", "``-1``", "one category", ""
   "","``dxrect``", "real", "x-direction grid spacing (centimeters) for rectangular grid", "30.e5 (30 km)"
   "","``dyrect``", "real", "y-direction grid spacing (centimeters) for rectangular grid", "30.e5 (30 km)"
