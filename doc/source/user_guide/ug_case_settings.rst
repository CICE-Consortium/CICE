...
.. csv-table:: **setup_nml namelist options**
   ...
   "``dumpfreq_base``", "init", "restart output frequency is relative to the model initial date", "init"
   "", "zero", "restart output frequency is relative to 0000-01-01-00000", ""
   ...
   "``histfreq_base``", "init", "history output frequency is relative to the model initial date", "zero"
   "", "zero", "history output frequency is relative to 0000-01-01-00000", ""
