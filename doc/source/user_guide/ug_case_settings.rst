...
.. csv-table:: **setup_nml namelist options**
   ...
   "``dbug``", "logical", "if true, write extra diagnostics", "``.false.``"
   "``diagfreq``", "integer", "frequency of diagnostic output in timesteps, "24"
   "``diag_type``", "string", "diagnostic output option", "``stdout``"
   "", "``stdout``", "write diagnostic output to stdout", ""
   ...
   "``dump_last``", "logical", "if true, write restart on last time step of simulation", "``.false.``"
   "``dumpfreq``", "string", "write restart frequency with ``dumpfreq_n``", "``y``"
   ...
   "``histfreq``", "string array", "defines output frequencies with ``histfreq_n``", "'1','h','d','m','y'"
   ...
   "``lcdf64``", "logical", "if true, use 64-bit netcdf format", ".false."
   ...
   "``print_global``", "logical", "print diagnostic data, global sums", "``.true.``"
   ...
   "``runtype``", "string", "initial run type method", "``initial``"
   "", "``continue``", "restart using ``pointer_file``", ""
   "", "``initial``", "start from ``ice_ic``", ""
   "``use_leap_years``", "logical", "if true, include leap days", "``.false.``"
...
.. csv-table:: **grid_nml namelist options**
   :header:  "options/format", "description", "default value"
   :widths: 15, 15, 30, 15 
   ...
   "``kcatbound``", "integer", "category formulation", "1"
   "", "``-1``", "single category", ""
   "", "``0``", "old formulation", ""
   "", "``1``", "new formulation", ""
   "", "``2``", "WMO standard", ""
...
.. csv-table:: **domain_nml namelist options**
   ...
   "``distribution_type``", "string", "block distribution method", "``cartesian``"
   "", "``cartesian``", "distribute blocks in 2D Cartesian array with ``processor_shape``", ""
   ...
   "``distribution_wght``", "string", "distribution weight method", "``latitude``"
   "", "``block``", "full block size sets ``work_per_block``", ""
   ...
   "``ew_boundary_type``", "string", "boundary conditions in x-direction", "``cyclic``"
   ...
   "``ns_boundary_type``", "string", "boundary conditions in y-direction", "``open``"
   ...
   "``processor_shape``", "string", "distribution of blocks with ``distribution_type=cartesian``", "``slenderX2``"
...
.. csv-table:: **thermo_nml namelist options**
   ...
   "``conduct``", "string", "conductivity scheme", "bubbly"
   ...
   "``kitd``", "integer", "ITD approximation", "1"
   "", "``0``", "delta function ITD approximation", ""
   "", "``1``", "linear remapping ITD approximation", ""
   "``ksno``", "real", "snow thermal conductivity", "0.3"
   "``ktherm``", "integer", "thermodynamic model", "1"
...
.. csv-table:: **dynamics_nml namelist options**
   ...
   "", "", "", ""
   "``advection``", "string", "remapping advection scheme", "``remap``"
   "", "``remap``", "linear remapping advection", ""
   ...
   "``coriolis``", "string", "Coriolis implementation", "``latitude``"
   "", "``constant``", "Constant coriolis value = 1.46e-4", ""
   "", "``latitude``", "Coriolis variable by latitude", ""
   "", "``zero``", "Zero coriolis", ""
   "``e_ratio``", "real", "EVP ellipse aspect ratio", "2.0"
   "``kdyn``", "integer", "dynamics algorithm", "1"
   "", "``-1``", "dynamics OFF", ""
   "", "``0``", "dynamics OFF", ""
   "", "``1``", "EVP dynamics", ""
   "", "``2``", "EAP dynamics", ""
   "``kevp_kernel``", "integer", "EVP solver", "0"
   "", "``0``", "standard 2D", ""
   "", "``2``", "1D (not fully validated)", ""
   "``kstrength``", "integer", "ice strength formulation", "1"
   "", "``0``", "ice strength formulation :cite:`Hibler79`", ""
   "", "``1``", "ice strength formulation :cite:`Rothrock75`", ""
   "``krdg_partic``", "integer", "ridging participation function", "1"
   "", "``0``", "old ridging participation function", ""
   "", "``1``", "new ridging participation function", ""
   "``krdg_redist``", "integer", "ridging redistribution function", "1"
   "", "``0``", "old ridging redistribution function", ""
   "", "``1``", "new ridging redistribution function", ""
   "``kridge``", "integer", "ridging flag", "1"
   "", "``-1``", "Ridging Disabled", ""
   "", "``1``", "Ridging Enabled", ""
   "``ktransport``", "integer", "transport flag", "1"
   ...
   "``yield_curve``", "string", "", "``ellipse``"
   "", "``ellipse``", "elliptical yield curve", ""
   "", "", "", ""
...
.. csv-table:: **shortwave_nml namelist options**
   ...
   "``albedo_type``", "string", "albedo implementation", "``ccsm3``"
   "", "``ccsm3``", "NCAR CCSM3 albedos", ""
   ...
   "``shortwave``", "string", "shortwave distribution method", "``ccsm3``"
   "", "``ccsm3``", "NCAR CCSM3 distribution method", ""
...
.. csv-table:: **ponds_nml namelist options**
   ...
   "``frzpnd``", "string", "pond refreezing forumulation", "``cesm``"
...
.. csv-table:: **forcing_nml namelist options**
   ...
   "", "", "", ""
   "``atmbndy``", "string", "boundary layer formulation", "``default``"
   ...
   "``atm_data_format``", "string", "atmo forcing file format", "``bin``"
   "", "``bin``", "read direct access, binary files", ""
   "", "``nc``", "read netcdf atmo forcing files", ""
   "``atm_data_type``", "string", "atmo data formulation", "default"
   ...
   "``bgc_data_type``", "string", "bgc data formulation", "``default``"
   ...
   "``calc_strair``", "logical", "wind stress and speed formulation", "``.true.``"
   ...
   "``default_season``", "string", "Sets initial values of forcing and is overwritten if forcing is read in.", "``winter``"
   "", "``summer``", "use summer values", ""
   "", "``winter``", "use winter values", ""
   "``emissivity``", "real", "emissivity of snow and ice", "0.95"
   "``fbot_xfer_type``", "string", "ocean heat transfer coefficient scheme", "``constant``"
   "", "``Cdn_ocn``", "variable ocean heat transfer coefficient", ""
   "", "``constant``", "constant ocean heat transfer coefficient", ""
   "``fe_data_type``", "string", "forcing value for iron", "``default``"
   ...
   "``l_mpond_fresh``", "logical", "pond water drain scheme", "``.false.``"
   ...
   "``ocn_data_format``", "string", "ocean forcing files format", "``bin``"
   "", "``bin``", "read direct access, binary files", ""
   "", "``nc``", "read netcdf ocean forcing files", ""
   "``ocn_data_type``", "string", "ocean data formulation", "``default``"
   "", "``clim``", "climatological data", ""
   "", "``default``", "constant values defined in the code", ""
   "", "``hycom``", "HYCOM ocean forcing data in netcdf format", "Constant initial forcing"
   "", "``ncar``", "POP ocean forcing data", ""
   "``precip_units``", "string", "liquid precipitation data units", "``mks``"
   "", "``mks``", "", ""
   "", "``mm_per_month``", "", ""
   ...
   "``tfrz_option``", "string", "ocean freezing temperature formulation", "``mushy``"
   ...
   "``update_ocn_f``", "logical", "include frazil water/salt fluxes in ocn fluxes", "``.false.``"
   ...
   "``wave_spec_type``", "string", "wave data interactions", "``none``"
...
.. csv-table:: **zbgc_nml namelist options**
   ...
   "``bgc_flux_type``", "string", "ice–ocean flux velocity scheme", "``Jin2006``"
   ...
   "``ratio_Si2N_phaeo``", "real", "algal Si to N in mol/mol phaeocystis", "0."
   "``ratio_Si2N_sp``", "real", "algal Si to N in mol/mol small plankton", "0."
...
.. csv-table:: **icefields_nml namelist options**
   ...
   "``f_<var>_ai``", "string", "grid cell average of ``<var>`` (:math:`\times a_i`) to history", ""
   "", "``d``", "write history every ``histfreq_n`` days", ""
   "", "``h``", "write history every ``histfreq_n`` hours", ""
   "", "``m``", "write history every ``histfreq_n`` months", ""
   "", "``md``", "*e.g.,* write both monthly and daily files", ""
