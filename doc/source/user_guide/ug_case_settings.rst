...
.. csv-table:: **setup_nml namelist options**
   ...
   "``dumpfreq_base``", "init", "restart output written relative to the model initial date with ``dumpfreq``", "init"
   "", "zero", "restart output frequency written relative to a reference date of 0000-01-01-00000 with ``dumpfreq``", ""
   ...
   "``histfreq_base``", "init", "history output written relative to the model initial date with ``histfreq``", "zero"
   "", "zero", "history output frequency written relative to a reference date of 0000-01-01-00000 with ``histfreq``", ""
