...
.. csv-table:: *Alphabetical Index*
   ...
   "rsnw", "snow grain radius", " :math:`\times` 10\ :math:`^{-6}` m"
   "rsnw_fall", "radius of new snow", "54.526 :math:`\times` 10\ :math:`^{-6}` m"
   ...
   "rsnw_tmax", "maximum snow radius", "1500 :math:`10^{-6}` m"
   ...
   "snowage_drdt0", "snow aging parameter (initial rate of change of effective radius)", " "
   "snowage_rhos", "snow aging parameter (density)", " "
   "snowage_kappa", "snow aging best-fit parameter", " "
   "snowage_tau", "snow aging best-fit parameter (time)", " "
   ...
   "snwlvlfac", "fractional increase in snow depth for bulk redistribution", "0.3"
