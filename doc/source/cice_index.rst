...
.. csv-table:: *Alphabetical Index*
   ...
   "debug_blocks", ":math:`\bullet` write extra diagnostics for blocks and decomposition", ".false."
   "debug_forcing", ":math:`\bullet` write extra diagnostics for forcing inputs", ".false."
   ...
   "fyear_init", ":math:`\bullet` initial forcing data year", ""
   "**G**", "", ""
   ...
   "month_init", ":math:`\bullet` the initial month", ""
   ...
   "npt", ":math:`\bullet` total run length values associate with npt_unit", ""
   ...
   "sec_init", ":math:`\bullet` the initial second", ""
