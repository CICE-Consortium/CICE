...
There are four general cases: (1) :math:`T_{sf} < 0` °C, snow
present; (2) :math:`T_{sf} = 0` °C, snow present;
(3) :math:`T_{sf} < 0` °C, snow absent; and
(4) :math:`T_{sf} = 0` °C, snow absent. For case 1 we have
